...
class UsuarioSistema:
    def __init__(self):
        ...
        self.arquivo_deletados = 'projeto_pt5/dados/usuarios_deletados.json'  # Caminho para o arquivo JSON de usuários deletados
        self.criar_arquivo_deletados()  # Garante que o arquivo de deletados exista   
